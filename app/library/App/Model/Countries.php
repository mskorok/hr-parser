...
class Countries extends Model
{
    ...
    public function initialize(): void
    {
        ...
        $this->hasMany('id', Companies::class, 'country', ['alias' => 'Companies']);
        $this->hasMany('id', Users::class, 'country', ['alias' => 'Users']);
        $this->hasMany('id', Vacancies::class, 'country_id', ['alias' => 'Vacancies']);
    }
